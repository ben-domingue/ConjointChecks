##main function
omni.check<-function(N,n,n.iter) {#this checks both single and double cancellation
  n/N->dat
...
############################################################
#glorified wrapper
ConjointChecks<-function(N,n,n.3mat=10,par.options=NULL,seq.seed=NULL,par.seed=NULL) {#N is the number of total tries per cell, n is the number correct
